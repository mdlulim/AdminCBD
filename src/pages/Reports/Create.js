...
export default function CreateSite(props) {
    const breadcrumb = { heading: "Create Site" };
    return (
                ...
                <Col md={12}>
                    <div id="smartwizard" className="sw-main sw-theme-dots">
                        <ul className="nav nav-tabs step-anchor">
                            <li className="nav-item active"><a href="#step-1" className="nav-link">Step 1<br /><small>Website Information</small></a></li>
                            <li className="nav-item"><a href="#step-2" className="nav-link">Step 2<br /><small>Site Configuration</small></a></li>
                            <li className="nav-item"><a href="#step-3" className="nav-link">Step 3<br /><small>File Management</small></a></li>
                            <li className="nav-item"><a href="#step-4" className="nav-link">Step 4<br /><small>Site Deployment</small></a></li>
                        </ul>
                        <div className="sw-container tab-content">
                            <div id="step-1" className="tab-pane step-content" style={{ display: 'block' }}>
                                ...
                                <p>
                                    Please use the form below to specify website information. Make sure all
