...
class MemberService {
  ...
  static async getMembers(offset=null, limit=null, status=null, start_date = null, end_date = null, search = null) {
    const fields = {
      offset,
      limit,
      status,
    ...
    return await axios({
      ...
      method: 'GET',
      headers: headers,
      url: `${Config.API.BASE_URL}/users?group=member${query.substring(0, query.length -1)}`,
    }).then(json => json.data)
    .then(res => {
